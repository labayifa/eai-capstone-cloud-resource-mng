    ...
    clientside: {
        theme_switcher_callback: function (n_clicks) {
            ...
            let lightColorScheme = {
                ...
                "components": {
                    // Additional component styles for light theme
                },
            };
            ...
            let darkColorScheme = {
                ...
                "colors": custom_theme_colors,
                "components": {
                    // Additional component styles for dark theme
                },
                "shadows": {
            ...
            if (!n_clicks || n_clicks % 2 === 1) {
                ...
                return [darkColorScheme, 'dark', lightIcon, 'Light'];  // Switch to light theme on next click
            } else {
                document.documentElement.style.setProperty('--aside-bg-color', 'rgb(248, 246, 246)');
                return [lightColorScheme, 'light', darkIcon, 'Dark'];  // Switch to dark theme on next click
            }
        },
